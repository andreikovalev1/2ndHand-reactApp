        ...
        <div className='group relative flex flex-col bg-white rounded-2xl shadow-sm hover:shadow-md transition-shadow overflow-hidden border border-slate-100'>
            <div className='relative aspect-[3/4] bg-gray-100'>
                ...
                <div className="absolute bottom-3 left-3 flex gap-1 flex-wrap">
                    {product.rating > 4.5 && (
                        <span className="px-2 py-0.5 text-[10px] font-bold uppercase rounded-full text-white bg-sky-400">
                            Top Rated
                        </span>
                    )}
                </div>
            ...
            <div className="p-4 flex flex-col gap-2 grow">
                ...
                <div className="flex items-end justify-between mt-auto">
                    <div className="flex flex-col">
                         ...
                         <span className={cn("text-lg font-bold", originalPrice ? "text-red-500" : "text-slate-800")}>
